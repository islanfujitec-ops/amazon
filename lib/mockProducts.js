...
function getMockProducts(keywords, limit = 10) {
  ...
  return filtered
    ...
    .map(p => ({
      ...p,
      affiliate_url: `https://www.amazon.com.br/dp/${p.asin}?tag=tainadadecio-20`,
...
function getMockProductByASIN(asin) {
  ...
  if (product) {
    return {
      ...product,
      affiliate_url: `https://www.amazon.com.br/dp/${product.asin}?tag=tainadadecio-20`,
      url: `https://www.amazon.com.br/dp/${product.asin}`
    };
  }
  return null;
}

module.exports = { getMockProducts, getMockProductByASIN };
